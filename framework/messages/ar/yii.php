...
return array (
  ...
  '{attribute} "{value}" is invalid.' => '{attribute} "{value}" غير صالح.',
  '{attribute} cannot accept more than {limit} files.' => 'يمكن {attribute} لا يقبل أكثر من {limit} الملفات.',
  ...
  'Please fix the following input errors:' => 'يرجى تصحيح أخطاء الإدخال التالية',
  ...
  '{attribute} "{value}" has already been taken.' => '{attribute} "{value}" وقد تم بالفعل اتخاذها',
  '{attribute} cannot be blank.' => '{attribute} لا يمكن أن تكون فارغة',
...
{attribute} هو كبير جدا (الحد الأقصى هو {max})',
  '{attribute} is too long (maximum is {max} characters).' => '{attribute} طويل جدا (الحد الأقصى هو {max} حرف)',
