<?php
class CountryController extends SBaseController
{
	/**
	...
	public function actionDynamicsign(){
	    
		
	$data=Country::model()->find('country_id=:country_id', 
	                  array(':country_id'=>(int) $_POST['ExchangeRate']['country_id']));
	 
	 	echo $data->currancy_sign;
		//$arr["sign"]=$data->currancy_sign;
		//$arr["currancy_name"]=$data->country_currancy;
