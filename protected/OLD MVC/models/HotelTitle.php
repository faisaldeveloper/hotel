...
class HotelTitle extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title, application_title, website, logo_image', 'required'),
			array('title, application_title, website, logo_image, bg_image', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, title, application_title, website, logo_image, bg_image', 'safe', 'on'=>'search'),
		);
	}
	/**
	...
	public function attributeLabels()
	{
		return array(
			'id' =>  Yii::t('views', 'ID'),
			'title' =>  Yii::t('views', 'Title'),
			'application_title' =>  Yii::t('views', 'Application Title'),
			'website' =>  Yii::t('views', 'Website'),
			'logo_image' =>  Yii::t('views', 'Logo Image'),
			'bg_image' =>  Yii::t('views', 'Bg Image'),
		);
	}
	/**
