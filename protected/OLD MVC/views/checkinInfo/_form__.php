...
/*
$("#Accounts_name").inputmask("99-99-999999",{placeholder:"_", clearIncomplete: true });

$("#Patients_imr_no").inputmask("888888888888",{placeholder:""});

$("#Patients_fname").inputmask("bbbbbbbbbbbbbbb",{placeholder:""});
$("#Patients_name").inputmask("bbbbbbbbbbbbbbb",{placeholder:""});

$("#Patients_age").inputmask("999",{placeholder:""});

$("#Patients_dob").inputmask("99-99-9999",{placeholder:"_", clearIncomplete: true });


$("#Admissions_doadmission").inputmask("99-99-9999",{placeholder:"_", clearIncomplete: true });
$("#Admissions_dodischarge").inputmask("99-99-9999",{placeholder:"_", clearIncomplete: true });
*/
 ...
 $(function(){
	...
	// $(".form input[type=\"text\"]:has([hasDatepicker])").css('backgroundColor','red');
	 ...
	 //$(".form select:eq(4)").css('width','120px'); //complany select list width is restricted. CheckinInfo_guest_company_id
	  $("#CheckinInfo_guest_company_id").css('width','70px');	  
	 $("#GuestInfo_guest_country_id").css('width','118px');
	  
	 $("textarea").css('width','140px','min-height','20px');
...
<fieldset>
 ...
 <div class="row" style="float:left; margin-left:5px;">    
    ...
    <?php echo $form->dropDownList($guest_info,'guest_salutation_id', CHtml::listData(Salutation::model()->findAll(), 'salutation_id', 
	  ...
	  echo $form->dropDownList($model,'guest_company_id', CHtml::listData(Company::model()->findAll($con), 'comp_id','comp_name'), array('options' => array('1'=>array('selected'=>true))));?>      
	...
	<!--<div class="row" style="float:left; margin-left:5px;">   			   
	   ...
	   <?php //echo $form->textField($model,'sale_person_id'); ?>
		...
		<?php // $form->error($model,'sale_person_id'); ?>   
   </div>-->
      
	<!--<div class="row" style="float:left; margin-left:5px;">   	
   		<?php //echo $form->labelEx($model,'chkin_id'); ?>        
	  
       <?php //$form->error($model,'chkin_id'); ?>
   </div>-->	
     <?php 
   ...
   <?php echo $form->textField($guest_info,'guest_mobile',array('maxlength'=>'12',
	...
	<!--<div class="row" style="float:left; margin-left:5px;">   	
     ...
     //new record and get id?>
		...
		<?php //echo $form->textField($model,'guest_id'); ?><?php //$form->error($model,'guest_id'); ?>
      </div> --> 
	...
	/*	 $guest_info->guest_gender = 'M'; 
		...
		<?php //$form->error($guest_info,'guest_gender'); ?>
     </div> --> 
...
<fieldset> <legend class="mcelegend"  style="color:#900;">Room Rate Information:</legend> 
  ...
  <?php echo $form->labelEx($model,'room_id'); ?>
   ...
   <?php $form->error($model,'rate'); ?>
	...
	<?php //$form->error($model,'bed_tax'); ?></span>
    <!--<input type="text" id="CheckinInfo_b_tax" name="CheckinInfo[b_tax]" readonly="readonly" class=" mceinput" style="width:10px" />-->
    <?php //echo $form->textField($model,'b_tax',array('size'=>10,'maxlength'=>25,'onblur'=>"tamount_ext()",'disabled'=>"disabled")); ?>
    </div>  
    ...
    <!--<input type="checkbox" id="e_bd" onclick="show()"/>-->
    <?php echo $form->checkBox($model,'e_bd',array('value' => 'Y', 'uncheckValue'=>'N','onclick'=>'show()')); ?> 
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
    <!--<input type="text" id="extra_bed" name="extra_bed" style="width:50px;" onblur="tamount_ext()" disabled="disabled" />-->	 
    ...
    <?php 
	echo $form->textField($model,'gst_amount',array()); ?>
   ...
   <?php //echo $form->checkBox($model,'bed_tax',array('value' => 'Y', 'uncheckValue'=>'N','onclick'=>'btax()')); ?>            
    ...
    <?php //echo $form->textField($model,'gst_amount',array('value'=>0)); ?>
    ...
    </span><?php echo $form->labelEx($model,'prev_night'); ?>
    </div>  
