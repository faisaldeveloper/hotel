...
$branch_address .= "<br> Phone: $branch_phone Fax: $branch_fax <br> email: $branch_email";
	...
	//availabe
	$total_availabe = $total_rooms ; $total_rooms - ($total_occupied+$total_dirty); //Yii::app()->db->createCommand("select count(mst_room_id) from hms_room_master where mst_room_status = 'V' and branch_id = $branch_id")->queryScalar();
...
-->
 <tr>    
    <td colspan="3" align="center" style="font-size:12px"><strong><?php echo $hotel_title; ?></strong></td>   
  </tr>
  <tr>
...
<table width="100%" border="0" align="center">
      <tr>
       <!-- <td><strong>Sr#</strong></td>
        ...
        <td align="left"><strong>CNIC</strong></td>
 ...
 foreach($chkin_info as $rs){
	 ...
	 $company=Company::model()->findAll("comp_id =$guest_company_id");
      ...
      <tr>
       <!-- <td align="center" valign="top"><?php //echo $i;?></td>
        ...
        <td align="left"><?php echo $guest_identity_no; ?></td>
   ...
   <br />
	...
	$sql = "select count(gi.guest_id) AS foreigners From hms_checkin_info ci LEFT JOIN hms_guest_info gi ON ci.guest_id = gi.guest_id WHERE ci.chkout_status = 'N' AND gi.guest_country_id > 1 and ci.branch_id = $branch_id";
