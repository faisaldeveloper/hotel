...
?>
 <div id="licence_type_error_div">
    <p class="note">Fields8 with <span class="required">*</span> are required.</p>
 </div>
...
<?php echo CHtml::ajaxSubmitButton('Create Licence Type',CHtml::normalizeUrl(array('licencetypes/addnew','render'=>false)),
					array(
					'type'=>'POST',
					...
					'success'=>'js: function(data) {
                        ...
                        $("#licencetypeDialog").dialog("close");
						}
                    }'
					
					),array('id'=>'closelicencetypeDialog')); ?>
    </div>
