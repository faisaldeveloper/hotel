...
// check stay info of the 
if($bill_no > 0){
$sql22 = "select chkout_status from hms_checkin_info where chkin_id = $bill_no";
$guest_status = Yii::app()->db->createCommand($sql22)->queryScalar();
}
...
<?php if(!isset($_REQUEST['id'])) { echo "<br /> <br /><br />"; } ?>
...
<div style="float:left;padding-right:20px;">
  ...
  <?php if ($bill_no > 0 && $guest_status=='N'){ ?>      
<div style="float:left;padding-right:20px;">
