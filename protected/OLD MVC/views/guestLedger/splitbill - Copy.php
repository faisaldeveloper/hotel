...
<table width="100%"  border="0" align="center">
  <tr>
    ...
    <td rowspan="3"><?php echo date('j F, Y');?></td>
  </tr>
  <tr>
    <td colspan="3" align="center"><strong><?php echo ucwords($branch_address); ?></strong></td>
  </tr>
  <tr>    
    <td colspan="3" align="center"><strong>Guest Folio(Split Folio Copy)</strong></td>
  </tr>
</table>
...
<table width="100%" border="0" align="center"> 
  <tr class="tr_border">
      <td width="43"><strong>Sr#</strong></td>
