...
<h2 align="center"> <?php echo "GST Reg. No".$gst_no. " NTN No: ". $ntn_no; ?></h2>
 ...
 <table width="100%" border="1" align="center" style="margin-top:13px;">     
      ...
      <tr>
        ...
        <td colspan="3"><?php echo ucwords($guest_address);?></td>
        <?php /*?> <td><strong>Prev Night:</strong></td>
        <td><?php echo $prev_night;?></td><?php */?>
      ...
      <tr>
        ...
        <td colspan="3"><?php echo $company_name;?></td>
       <?php /*?> <td><strong>Company:</strong></td>
        <td><?php echo $company_name;?></td><?php */?>
...
<div style="width:100%;; border-bottom: solid 1px #000; margin:5px 0;"></div>
<p align="center" style="font-size:12px"><!--99-E Jinnah Avenue, Blue Area, Islamabad. Phone: +92-51-2277890 Fax: +92-51-2273967/2827180. Email: Info@hotelcrownplaza.com-->  Elodger Application developed by <a href="http://www.maaliksoft.com">maaliksoft.com</a>, Contact No:  +92 051 2287033</p>
