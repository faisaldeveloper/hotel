...
$sql = "select * from hms_checkin_info ci LEFT JOIN hms_company_info cy ON ci.guest_company_id = cy.comp_id where cy.comp_name NOT LIKE 'Walk%' and  chkin_date between '$from_date1' and '$to_date1' ". $gst_show ." and ci.branch_id = $branch_id  order by guest_folio_no";
...
<div class="container_mce">
  ...
  <tr>   
    <td colspan="3" align="center" style="font-size: 12px;"><strong>CORPORATE CHECKIN REPORT</strong></td>    
  </tr>
  <tr>      
  ...
  <table width="100%" border="0">
    ...
    <tr class="text">
      ...
      <td align="left"><?php echo ucwords($guest_name);?></td>
