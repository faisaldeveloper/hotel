...
$checkin =CheckinInfo::model()->findAll("chkout_status ='Y' and guest_company_id!='1' and  chkout_date between '$from_date1' and '$to_date1' and branch_id = $branch_id ". $gst_show ." ORDER BY room_id");
	//echo "--bb-".$checkin; 
 ?>
...
<div class="container_mce">
  ...
  <tr>    
    <td colspan="3" align="center"><strong>Corporate Check-Out Report <?php echo $showdate; ?> </strong></td>
  </tr>
</table>
