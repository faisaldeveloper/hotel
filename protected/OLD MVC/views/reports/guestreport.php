...
<div class="container_mce">
 ...
 <tr>   
    <td colspan="3" align="center" style="font-size: 12px;"><strong>All GUEST REPORT</strong></td>    
  </tr>
  <tr>      
...
<table width="100%" border="1" align="center">
      ...
      <?php
      $RoomMaster = RoomMaster::model()->findAll("branch_id = $branch_id Order By mst_floor_id");
 foreach($RoomMaster as $rs){
	 ...
	 if($mst_room_status=='V')$mst_room_status="Available";	
      ...
      <tr>
        ...
        <td><?php echo $mst_room_childs;?></td>       
