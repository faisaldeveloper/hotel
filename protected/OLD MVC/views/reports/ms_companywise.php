...
<div class="container_mce">
  ...
  <tr>    
    ...
    <td colspan="3" align="center"><strong>Market Segment Report Company Wise <br/>  From: <?php echo date("j F, Y",strtotime($from_date)) . " &nbsp;&nbsp;&nbsp;&nbsp;TO: ". date("j F, Y",strtotime($to_date)); ?></strong></td>
