...
$checkin =CheckinInfo::model()->findAll("chkout_status ='N' ". $gst_show ." and  chkout_date between '$from_date1' and '$to_date1' and branch_id = $branch_id Order by room_id ");
...
<div class="container_mce">
  ...
  <tr>    
    ...
    <td colspan="3" align="center"><strong> Overall Expected General Check-Out Report <?php echo $showdate; ?></strong></td>
