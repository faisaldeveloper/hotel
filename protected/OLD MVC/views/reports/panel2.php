    ...
    <td colspan="4">&nbsp;
        ...
        <select name="report_type" id="report_type" onchange="toggleDates(this.value)">
                        ...
                        <optgroup value="" label="-- Guests Reports --"> 
                             ...
                             <option value="34">Police Report For Check In Guest</option>           
...
function toggleDates(x){
	if(x==2 || x==3  || x==7 || x==8 || x==9 || x==10 || x==12 || x==14 || x==22 || x==23 || x==25 || x==27 || x==28 || x==29 || x==33 || x==34 || x==35 || x==36 || x==42 || x==46 || x==51 || x==121){
		$("#datesRow").show();
		if(x==36)$("#con").show();
		if(x==25){$("#datesRow").hide(); $("#con").show(); }
	}
