...
if(isset($sval) && $sval=='ON') $gst_show = " AND gst_show > 0";
      ...
      $chkin_info = CheckinInfo::model()->findAll("branch_id = $branch_id ". $gst_show ." order by chkin_id");
...
<p align="right" style="margin-right:100px;"><input id="print" type="button" value="Print" onclick="printthis(this.id)" /> </p>
