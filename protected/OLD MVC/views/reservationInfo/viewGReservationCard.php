...
<div class="container_mce">
  ...
  <table width="746" border="0">
    ...
    <tr>
      ...
      <td align="center"><strong> <?php echo Yii::t('views','') ?> <?php echo Yii::t('views','Reservation Card') ?> </strong></td>

      <td><strong> <?php echo Yii::t('views','') ?> <?php echo Yii::t('views','Reservation #:') ?> </strong></td>
  ...
  <p><strong>	 
  <?php echo Yii::t('views','This reservation is only valid subject to receipt of confirmation from the Guest / Company') ?>
  </strong></p>
  ...
  <table width="743" border="1">
    ...
    <tr>
      ...
      <td width="54" rowspan="2"><strong><?php echo Yii::t('views','MOP') ?> </strong></td>
