...
class User extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'hmsCheckinInfos' => array(self::HAS_MANY, 'CheckinInfo', 'chkin_user_id'),
			'hmsCheckinInfos1' => array(self::HAS_MANY, 'CheckinInfo', 'chkout_user_id'),
			'hmsCompanyInfos' => array(self::HAS_MANY, 'CompanyInfo', 'user_id'),
			'hmsExchangeRates' => array(self::HAS_MANY, 'ExchangeRate', 'user_id'),
			'hmsGuestInfos' => array(self::HAS_MANY, 'GuestInfo', 'user_id'),
			'hmsReservationInfos' => array(self::HAS_MANY, 'ReservationInfo', 'user_id'),
			'hmsReservationInfos1' => array(self::HAS_MANY, 'ReservationInfo', 'cancel_by'),
			'hmsRoomTypeRates' => array(self::HAS_MANY, 'RoomTypeRate', 'user_id'),
	...
	public function attributeLabels()
	{
		return array(
			'id' => Yii::t('views', 'ID'),
			'username' => Yii::t('views', 'Username'),
			'password' => Yii::t('views', 'Password'),
			'email' => Yii::t('views', 'Email'),
			'hotel_id' => Yii::t('views', 'Hotel'),
			'hotel_branch_id' => Yii::t('views', 'Hotel Branch'),
		);
	}
	/**
	...
	public function search()
	{
		...
		////$criteria->compare('hotelBranch.branch_address',$this->hotel_branch_id, true);
		
		
		////$criteria->with=array('hotel');
		////$criteria->with=array('hotelBranch');
