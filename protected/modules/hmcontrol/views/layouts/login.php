...
<div style="clear:both"></div>
	...
	<div id="header">
		<div id="logo"><h2 align="center" style="color:#FFF;">WelCome To <?php echo CHtml::encode(Yii::app()->name); ?> [Admin] Login page</h2></div>
	</div><!-- header -->
    <!--
--->
...
?>
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> by Maaliksoft.com9<br/>
