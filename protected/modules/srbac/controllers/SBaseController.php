...
class SBaseController extends Controller {
  ...
  protected function beforeAction($action) {
    ...
    //echo "<br>module->id=".$this->module->id." module=$mod dellimiter=$del";
    $contrArr = explode("/", $this->id);
	
	//echo "<br>this->id=".$this->id." 0=".$contrArr[0]." 1=".$contrArr[1];
...
//    }
	...
	echo "<br>srbac is in debug mode";
      return true;
    }
  ...
  protected function onUnauthorizedAccess() {
     ...
     */
	//echo "<br>Class = SBaseController & Method = UnauthorizedAccess";
    ...
    if (Yii::app()->user->isGuest) {
      ...
      if (Yii::app()->request->isAjaxRequest) {
		...
		Yii::app()->user->setFlash('error', $error["title"]);
