...
$business_date = date("Y-m-d", strtotime($c_date));
...
$url = Yii::app()->createUrl('Reports/Codewisesummary');
    ...
    <tr class="text">
      ...
      <td align="left"><a href="<?php echo $url."/id/".$service_id.":".$business_date; ?>" target="_blank"> <?php echo $service_description;?> </a></td>         
