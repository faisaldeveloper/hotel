...
-->
 <tr>    
    <td colspan="3" align="center" style="font-size: 12px;"><strong>LONG STAYING IN-HOUSE REPORT</strong></td>    
  </tr>
  <tr>
...
<table width="100%" border="0" align="center">
	  ...
	  $last_5_days = $now - (60*60*24*5); // we consider long stay which is more than 7 days long
	  $lw = date('Y-m-d H:i:s', $last_5_days);	  
      $chkin_info = CheckinInfo::model()->findAll(" total_days >= 5 and  branch_id = $branch_id and chkout_status = 'N'  order by room_id");
	  
	  
	  $total_rooms = count($chkin_info);
	  $total_guest =0;
 foreach($chkin_info as $rs){
   ...
   <br />
	...
	<tr>
        <td width="4">&nbsp;</td>
        <td width="174"><strong>OCCUPIED ROOM(S) :</strong></td>
        <td width="42"><?php echo $total_rooms;?></td>
        <td width="69">&nbsp;</td>
        <td width="144"><strong>TOTAL GUEST(S) :</strong></td>
	<td width="352">&nbsp;<?php echo $total_guest;?></td>
      </tr>
	<tr>
        <td>&nbsp;</td>
