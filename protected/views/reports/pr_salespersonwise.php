...
<div class="container_mce">
  ...
  <tr>    
    ...
    <td colspan="3" align="center"><strong>Production Report Sales Person Wise <br/>  From: <?php echo date("j F, Y",strtotime($from_date)) . " &nbsp;&nbsp;&nbsp;&nbsp;TO: ". date("j F, Y",strtotime($to_date)); ?></strong></td>
 ...
 foreach($GuestLedger as $rs){
	 ...
	 $total_cr +=$cr;
      ...
      <tr>
        ...
        <td valign="top"><?php //echo ucwords($folio no);?></td>

        <td><?php echo ucwords($guest_name);?></td>

         <td><?php echo date("d/m/y",strtotime($c_date));?></td>

          <td><?php echo number_format($rate,0);?></td>

           <td><?php echo number_format($gst,0);?></td>
