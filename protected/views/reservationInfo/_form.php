...
$("label:contains(Total Reservations)").css('width','150px');
$("label:contains(Designation)").css('width','100px');
//$("label:contains(To Person)").css('width','100px');
});
...
$date_value = ''; 
if($model->isNewRecord==true && empty($model->chkin_date)){
	$date_value1 = date('d-m-Y'); 
	$date_value2 = date('d-m-Y', strtotime(date('Y-m-d'). ' +1 day')); 
	$t_days = 1;
	} 
//else if($model->isNewRecord==true && !empty($model->chkin_date)){ }
