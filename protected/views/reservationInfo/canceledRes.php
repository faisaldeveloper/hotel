...
$result = ReservationInfo::model()->findAll("chkin_status='N' and reservation_status = '2' and chkin_date between '$from_date1' and '$to_date1' and branch_id = $branch_id");
...
<div class="container_mce">
  ...
  <table width="846" border="0">
    ...
    <tr>
      ...
      <td colspan="5" align="center"><strong>Cancel Reservations Report</strong></td>
  ...
  <p><strong>Total Cancelations: <?php echo $total_record;?></strong></p>
