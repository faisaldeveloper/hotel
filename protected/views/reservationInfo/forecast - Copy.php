...
if($today >= $curr_date){	
 ...
 <tr style="padding: 10px 10px !important;" class="<?php echo $rowclass;?>">
	<td style="font-weight:bold; padding: 10px 0px 10px 0px; background-color: #CCC;"><?php echo "Forecast";?></td>
    <td align="right" style="font-weight:bold; padding: 10px 0px 10px 0px;  background-color:#CCC;"><?php echo $total_reservations + $total_occupied;?></td>
 </tr>
  <tr class="<?php echo $rowclass;?>">
	<td><b><?php echo "Available";?></b></td>
    <td align="right"><?php echo 64 - ($total_reservations + $total_occupied);?></td>
 </tr>
  <tr class="<?php echo $rowclass;?>">
	<td><b><?php echo "Occupanncy";?></b></td>
    <td align="right"><?php echo number_format(($total_reservations + $total_occupied)*64 /100, 2); ?></td>
 </tr>
...
<tr class="<?php echo $rowclass;?>">
 ...
 <tr style="padding: 10px 10px !important;" class="<?php echo $rowclass;?>">
	<td style="font-weight:bold; padding: 10px 0px 10px 0px; background-color: #CCC;"><?php //echo "Forecast";?></td>
    <td style="font-weight:bold; padding: 10px 0px 10px 0px;  background-color:#CCC;"><?php echo $total_reservations + $total_occupied;?></td>
 </tr>
  <tr class="<?php echo $rowclass;?>">
	<td><?php //echo "Available";?></td>
    <td><?php echo 64 - ($total_reservations + $total_occupied);?></td>
 </tr>
  <tr class="<?php echo $rowclass;?>">
	<td><?php //echo "Occupanncy";?></td>
    <td><?php echo number_format(($total_reservations + $total_occupied)*64 /100, 2); ?></td>
 </tr>
<?php } //end elses
