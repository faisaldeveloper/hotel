...
$html .='<div id="topheader">
 <span style="margin-left:40px;"> Confirmation # '. $reservation_id.'</span>
<div style="background: width:auto; height:auto; float:left; margin:0px 0px 0 55px;">';
$html .='<table border="1" width="95%" align="center">
<tr align="center">
<td>To:</td>
<td>'. ucwords(strtolower($to_person)) .'</td>
...
$html .='<br />
<font style="font-size:18px; font-weight:500;"><u> Special Instructions:</u>  '. ucwords($client_remarks).'</font><br />
VIP Handling:
<br />
<font style="font-size:18px; font-weight:500;"><u> Above Rates are Inclusive of Following Privileges</u></font><br />
...
<div style="background:; width:95%; height:auto; float:left; margin:5px; border:solid 1px; border-size:1px;">
...
<tr>
<td style="border:solid 1px; width:95%;">In case of Early Check In, <b>Previous night will be charged</b></td>
</tr>
<tr>
<td style="border:solid 1px; width:95%;"><b>Extension in stay, prior to advance notice and subjected to availability of room.</b></td>
</tr>
</table>';
