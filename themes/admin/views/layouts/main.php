            	...
            	<div class="dropdown notification">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            ...
                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/thumbs/thumb1.png" alt="" />
                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/thumbs/thumb2.png" alt="" />
                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/thumbs/thumb3.png" alt="" />
                            </a>
                        </li>
                ...
                <div class="row-fluid">
                	<div class="span8">
                    	<ul class="widgeticons row-fluid">
                        	<li class="one_fifth"><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/gemicon/location.png" alt="" /><span>Maps</span></a></li>
                            <li class="one_fifth"><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/gemicon/image.png" alt="" /><span>Media</span></a></li>
                            <li class="one_fifth"><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/gemicon/reports.png" alt="" /><span>Reports</span></a></li>
                            <li class="one_fifth"><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/gemicon/edit.png" alt="" /><span>New Article</span></a></li>
                            <li class="one_fifth last"><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/gemicon/mail.png" alt="" /><span>Check Mail</span></a></li>
                        	<li class="one_fifth"><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/gemicon/calendar.png" alt="" /><span>Events</span></a></li>
                            <li class="one_fifth"><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/gemicon/users.png" alt="" /><span>Manage Users</span></a></li>
                            <li class="one_fifth"><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/gemicon/settings.png" alt="" /><span>Settings</span></a></li>
                            <li class="one_fifth"><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/gemicon/archive.png" alt="" /><span>Archives</span></a></li>
                            <li class="one_fifth last"><a href=""><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/gemicon/notify.png" alt="" /><span>Notifications</span></a></li>
                        </ul>
